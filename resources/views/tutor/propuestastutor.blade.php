                    ...
                    <div class="card-body">
                        ...
                        <form class="card-body" method="POST" action="{{ route('propuestas') }}">
                            ...
                            <input type="hidden" name="id" id="id"
                                value="{{ isset($propuesta->id) ? $propuesta->id : '' }}">
                            <div class=" form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="titulo" type="text"
                                        ...
                                        value="{{ isset($propuesta->titulo) ? $propuesta->titulo : '' }}" required
                                        autocomplete="titulo">
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="descripcion" type="text"
                                        ...
                                        value="{{ isset($propuestas->description) ? $propuestas->descripcion : '' }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="linea_id" id="linea_id"
                                        ...
                                        <option value="{{ isset($lineas->id) ? $lineas->name : '' }}">Selecciones una
                                            Línea de Investigación</option>
                                        @foreach ($lineas as $l)
                                                    ...
                                                    <th scope="row">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <a href="{{ route('editPropuesta', $p->id) }}"
                                                            ...
                                                            <div class="footer-post">
                                                                ...
                                                                &ensp;
                                                                Publicado en: {{ $p->created_at->format('d/m/Y') }}
