                    ...
                    <div class="card-body col-md-11">
                        <form method="POST" action="{{ route('asignartema') }}">
                            ...
                            <div class=" form-group row">
                                <label for="user_id" class="col-md-4 col-form-label text-md-right">{{ __('Alumno') }}</label>
                            ...
                            <div class="col-md-6">
                                <input id="user" type="text" disabled='disabled'
                                    ...
                                    value="{{ isset($solicitud->user->name) ? $solicitud->user->name : '' }}"
                            ...
                            <input type="hidden" name="propuesta_id" id="propuesta_id" value="{{ $solicitud->propuesta->id}}">
                            <div class=" form-group row">
                                <label for="propuesta_id" class="col-md-4 col-form-label text-md-right">{{ __('Propuesta') }}</label>

                            <div class="col-md-6">
                                <input id="propuesta" type="text" disabled='disabled'
                                    class="form-control @error('propuesta') is-invalid @enderror" name="propuesta" required
                                    autocomplete="propuesta" autofocus
